...
public class LUDecomposition  {
	...
	*/
	...
	
	{
		...
		int som=0,som1=0,som2=0,som3=0;
		...
		*/
		...
		for (int j=1; j<n; j++){
			u[1][j]=a[1][j];
			l[j][1]=a[j][1]/a[1][1];      //  l[j][1]=division(a[j][1],a[1][1]); 
			
			System.out.println("val l[j][1]"+l[j][1]);
		}
		
		Matrix lu = new Matrix(l);
		System.out.println(""+lu.showMatrix());
